...
public class GameController_Spartial : MonoBehaviour
{
    public GameObject friendlyObj;
        ...
        List<Soldier_Spartial> enemySoldiers = new List<Soldier_Spartial>();
        List<Soldier_Spartial> friendlySoldiers = new List<Soldier_Spartial>();
        
        //Save the closest enemies to easier change back its material
        List<Soldier_Spartial> closestEnemies = new List<Soldier_Spartial>();
        ...
        {
            //Create a new grid
            grid = new Grid_Spartial((int)mapWidth, cellSize);
            ...
            for (int i = 0; i < numberOfSoldiers; i++)
            {
                ...
                enemySoldiers.Add(new Enemy_Spartial(newEnemy, mapWidth, grid));
                ...
                friendlySoldiers.Add(new Friendly_Spartial(newFriendly, mapWidth));
        ...
        void Update() 
        {
            ...
            for (int i = 0; i < friendlySoldiers.Count; i++)
            {
                ...
                Soldier_Spartial closestEnemy = grid.FindClosestEnemy(friendlySoldiers[i]);
        ...
        Soldier_Spartial FindClosestEnemySlow(Soldier_Spartial soldier)
        {
            Soldier_Spartial closestEnemy = null;
